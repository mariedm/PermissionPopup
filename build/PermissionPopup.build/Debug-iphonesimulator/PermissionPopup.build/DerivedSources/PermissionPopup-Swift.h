...
SWIFT_MODULE_NAMESPACE_PUSH("PermissionPopup")
@class UIWindow;
@class UIApplication;

SWIFT_CLASS("_TtC15PermissionPopup11AppDelegate")
...
///   </li>
/// </ul>
SWIFT_CLASS("_TtC15PermissionPopup15PermissionPopup")
@interface PermissionPopup : UIViewController
...
///   </li>
/// </ul>
- (IBAction)saidYes:(id _Nonnull)sender;
/// <ul>
///   <li>
///     SAID NO   **
///   </li>
/// </ul>
- (IBAction)saidNo:(id _Nonnull)sender;
